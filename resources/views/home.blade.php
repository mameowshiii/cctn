        ...
        <div class="lp-download-inner">
            <div class="lp-download-copy">
                ...
                <div style="margin-top: 2rem;">
                    <a href="{{ asset('downloads/cctn-app.apk') }}?v={{ filemtime(public_path('downloads/cctn-app.apk')) }}" class="lp-btn-primary" style="display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none;" download>
